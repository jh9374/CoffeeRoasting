...
Revision ID: a36adebf8bff
Revises: 
Create Date: 2021-03-25 00:39:26.525124
...
def upgrade():
    ...
    sa.Column('type', sa.Enum('review', 'roaster', 'product', name='image_types'), nullable=False),
